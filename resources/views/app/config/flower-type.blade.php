	...
	<div class="row">
		<div class="col-md-12">
			<div class="panel panel-default panel-cfbc">
				...
				<div class="panel-heading">Flower Type</div>
	...
	<div class="modal-dialog modal-md" role="document">
		<div class="modal-content">
			...
			<div class="modal-header">
				...
				<h4 class="modal-title">Flower Type</h4>
			</div>
...
$(document).ready(function() {
	...
	$form.submit(function(evt) {
		...
		if(action === 'insert')
			var url = "/app/api/flower-type";
		else
			var url = "/app/api/flower-type/"+id;

		$.post(url, data, function(response) {

			swal("Flower Type", "The flower type has been saved.", "success")
			$modal.modal('hide');
			table.ajax.reload();
